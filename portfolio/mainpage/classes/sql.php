<?php
    ...
    class SQL extends Database{
        ...
        function insetIntoreviewtTable($post,$productid,$loginid){
            $sql = "INSERT INTO review(post,productid,loginid,date)
                    VALUES('$post','$productid','$loginid',CURDATE())";
        ...
        public function displayReview2($loginid){
            $sql = "SELECT * FROM review INNER JOIN product ON review.productid = product.productid
                    WHERE review.loginid = '$loginid'";
            $result = $this->conn->query($sql);
        ...
        public function getSearchReview($id){
        ...
        public function updatereview($post,$id){
